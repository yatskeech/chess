import { DEFAULT_SIZE } from '../model/constants';
...
export function Rook({ size = DEFAULT_SIZE, colors, className }: RookProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        ...
        fill={colors.fill}
      />
      <path d="M22 46H49L55 54V62H16V54L22 46Z" fill={colors.fill} />
    </svg>
  );
}
